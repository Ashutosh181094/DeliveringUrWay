...
public class VendorDataClothAdapter extends RecyclerView.Adapter<VendorDataClothAdapter.VendorViewHolder>
{
    Context context;
    List<ClothProductDescription> data;
    ...
    public VendorDataClothAdapter(Context context, List<ClothProductDescription> data)
    {
    ...
    public VendorViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        ...
        VendorDataClothAdapter.VendorViewHolder holder=new  VendorDataClothAdapter.VendorViewHolder(view);
        return holder;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    button_delete.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            FirebaseUser user=FirebaseAuth.getInstance().getCurrentUser();
                            DatabaseReference deletedata=FirebaseDatabase.getInstance().getReference("productinfo").child("Clothing").child(""+user.getPhoneNumber()).child(""+data.get(position).product_name);
